...
function Home() {
    return (
        <div className='p-4 m-auto bg-zic-100 w-1/2 mt-10'>
            <h1 className='text-pink-400 font-semibold mb-3 text-2xl'>Home</h1>
            ...
            <button className='px-5 py-2 font-semibold rounded-full bg-blue-600 text-white'>Check it</button>
        </div>
    )
}
