...
function About() {
  return (
    <div className='p-4 m-auto bg-zic-100 w-1/2 mt-10'>
            <h1 className='text-lime-700 font-semibold mb-3 text-2xl'>About</h1>
            ...
            <button className='px-5 py-2 font-semibold rounded-full bg-fuchsia-700 text-white'>Check it</button>
        </div>
  )
}
