...
function Blog() {
  return (
    ...
    <h1 className='text-red-400 font-semibold mb-3 text-2xl'>Blog</h1>
    ...
    <button className='px-5 py-2 font-semibold rounded-full bg-yellow-600 text-white'>Check it</button>
</div>
  )
}
